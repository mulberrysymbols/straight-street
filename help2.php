	...
	<div id="colmid">
		<div id="colright">
			...
			<div id="col2">
                ...
                <div class='newsdate'>10 March 2009</div>
                <p>The Straight Street website has undergone conciderable re-work to better support the processes invovled in creating, reviewing, delivering and downloading the symbols.</p>
                </div>
                <!-- Column 2 end -->
    		</div>
			<div id="col3">
			...
			<div id="col3b">
                ...
                <h2>User guides</h2>
                <ul>
                  <li><a href="">Communication charts</a></li>
                  <li><a href="">Explanation of licenses</a></li>
                </ul>
                <h2>FAQ</h2>
                <ol>
                  <li><a href="">Why does it go bang?</a></li>
                  <li><a href="">Where is the widget?</a></li>
                </ol>
	...
	<div id="colmid">
		<div id="colright">
					...
					<div id="col1">
                        ...
                        <div id='splitr'>
                            ...
                            <h2>Photos and sounds</h2>
                                <p>Photos and sounds will be coming to Straight Street... <a href='Helpfiles/future.php#newmedia'>Read more</a></p>
                            </div>
                        </div>
						<!-- Column 1 end -->
					</div>
			...
			<div id="col2">
                ...
                <div id="col2b2"
                <!-- Column 2 start -->
                    <p><a href="gallery.php"><img title="Get list of symbols" alt="Get list of symbols" src="/img/workarea/j_media1.jpg"/></a></p>
                <!-- Column 2 end -->
        		</div>
    		</div>
			<div id="col3">
